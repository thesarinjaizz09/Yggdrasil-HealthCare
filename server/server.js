...
app.use("/api/v1/auth/tests", require("./db/routes/auth-tests"));
app.use("/api/v1/auth/admins", require("./db/routes/auth-admins"));
app.use("/api/v1/auth/doctors", require("./db/routes/auth-doctors"));
app.use("/api/v1/auth/patients", require("./db/routes/auth-patients"));
app.use("/api/v1/auth/employees", require("./db/routes/auth-employees"));
